          ...
          <div className="ctc-apply-1-container">
            <motion.h2
              ...
              variants={{
                ...
                visible: {
                  opacity: 1,
                  transition: { delay: 2, staggerChildren: 0.125 },
                },
              }}
              initial="hidden"
              animate="visible"
            ...
            >
              We're excited that you're interested in joining CTC this upcoming
              year.
            </motion.h2>
            <motion.h2
              className="ctc-apply-1-subhead"
            ...
            >
              While it is true that we aren't able to accept every applicant to
              our club, we do encourage you to fill out our application even if
              you're a beginner to the basics of design or development!
            </motion.h2>
            <motion.h2
              className="ctc-apply-1-subhead"
              // variants={{
            ...
            >
              ...
              <b>
                take initiative, are eager to learn, and are passionate about
                service and giving back to their community.
              </b>
            </motion.h2>
          </div>
        </motion.div>
